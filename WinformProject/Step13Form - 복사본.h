...
//	private: System::Windows::Forms::DataGridView^ dgvNetworkComponent;
	...
	public:
		Step13Form(ProjectDataSetBinder^ dataSet)
		{
			...
			m_chartType = CommConst::STEP13_CHART_00;//TOTAL COST - 내진보강(전)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dgvPriority->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Step13Form::dgvPriority_CellClick);
...
//그래프 타입6: 병렬 + 직렬 그래프
		...
		void DrawMainChart(array<String^>^ dataX, array<double>^ dataY1, array<double>^ dataY2, array<double>^ dataY3, array<double>^ dataY4) {
			//String^ scenarioName = cboSeismicSource->SelectedValue->ToString();
			//String^ sample = cboSample->SelectedItem->ToString();
			XYChart^ c = gcnew XYChart(chartViewer->Size.Width, chartViewer->Size.Height);
			...
			c->xAxis()->setColors(Chart::Transparent);
			c->xAxis()->setLabels(dataX);
			c->xAxis()->setTitle("시설물", "Arial Bold", 12);

			c->yAxis()->setColors(Chart::Transparent);
			c->xAxis()->setLabelStyle("Arial Bold", 12);
			c->yAxis()->setLabelStyle("Arial Bold", 12);
			//			c->yAxis()->setTitle("Cost (￦) 10^7", "Arial Bold", 12);
			c->yAxis()->setTitle("억원(￦)", "Arial Bold", 12);
			//c->yAxis()->setLabelFormat("{={value}/10000000}");
			c->yAxis()->setLabelFormat("{={value}/100000}");

			// Add a stacked bar layer
			BarLayer^ layer = c->addBarLayer2(Chart::Stack);

			// Add the three data sets to the bar layer
			layer->addDataSet(dataY1, 0xcc0000, "50년");
			layer->addDataSet(dataY2, 0x66aaee, "100년");
			layer->addDataSet(dataY3, 0xeebb22, "475년");
			layer->addDataSet(dataY4, 0xcc88ff, "1000년");
			// { 0xcc0000, 0x66aaee, 0xeebb22, 0xcccccc, 0xcc88ff };
		...
		void DrawChart_STEP13_CHART_00() {
		...
		void DrawChart_STEP13_CHART_01() {
			// 내진보강(후)
		...
		void DrawCharts() {
			...
			//그래프
			if (this->m_chartType->Equals(CommConst::STEP13_CHART_00)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_00");
				DrawChart_STEP13_CHART_00();
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_01)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_01");
				DrawChart_STEP13_CHART_01();
			}

			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_10)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_10");
				DrawChart_STEP13_CHART_10();
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_11)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_11");
				DrawChart_STEP13_CHART_11();
			}
			/*
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_21)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_21");
				DrawChart_STEP13_CHART_21();
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_22)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_22");
				DrawChart_STEP13_CHART_22();
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_23)) {
				Debug::WriteLine("=================> DrawCharts : STEP13_CHART_23");
				DrawChart_STEP13_CHART_23();
			}
			*/
		...
		//직접피해 - 내진보강(전)
		void DrawChart_STEP13_CHART_10() {
		
			DrawMainChart(m_chartDataX1, m_chartDataY1, m_chartDataY2, m_chartDataY3, m_chartDataY4);

		}
		//직접피해 - 내진보강(후)
		void DrawChart_STEP13_CHART_11() {
		...
		void setLabelText() {
			...
			if (this->m_chartType->Equals(CommConst::STEP13_CHART_00)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_00_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_00_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_01)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_01_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_01_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_10)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_10_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_10_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_11)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_11_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_11_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_21)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_21_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_21_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_22)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_22_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_22_TITLE_EN;
				}
			}
			else if (this->m_chartType->Equals(CommConst::STEP13_CHART_23)) {
				if (sUiLang->Equals("ko-KR")) {
					this->label5->Text = CommConst::STEP13_CHART_23_TITLE_KR;
				}
				else {
					this->label5->Text = CommConst::STEP13_CHART_23_TITLE_EN;
				}
			}
			else {
				if (sUiLang->Equals("ko-KR")) {
...
//				return;
			...
			if (cboDirectDamage->SelectedIndex == 0) {
				...
				for (int j = 0; j < this->m_dataSet->NetworkCompnentData->Rows->Count; j++) {
					...
					for (int k = 0; k < this->m_dataSet->RecurrencePeriodData->Length; k++) {
						...
						//그래프 Y축 값
						if (k == 0)
							m_chartDataY1[j] = value;
						if (k == 1)
							m_chartDataY2[j] = value;
						if (k == 2)
							m_chartDataY3[j] = value;
						if (k == 3)
							m_chartDataY4[j] = value;
	...
	private: System::Void cboPriority_SelectionChangeCommitted(System::Object^ sender, System::EventArgs^ e) {
		...
		if (this->cboPriority->SelectedIndex == 1) {
			m_chartType = CommConst::STEP13_CHART_21;
			//DrawCharts();
		}
		else if (this->cboPriority->SelectedIndex == 2) {
			m_chartType = CommConst::STEP13_CHART_22;
			//DrawCharts();
		}
		else if (this->cboPriority->SelectedIndex == 3) {
			m_chartType = CommConst::STEP13_CHART_23;
			//DrawCharts();
		}
		Debug::WriteLine("========= after ========>m_chartType:" + m_chartType);
	...
	private: System::Void cboDirectDamage_SelectionChangeCommitted(System::Object^ sender, System::EventArgs^ e) {
		...
		Debug::WriteLine("========= before ========>m_chartType:" + m_chartType);
		if (this->cboDirectDamage->SelectedIndex == 0) {
			m_chartType = CommConst::STEP13_CHART_10;
		}
		else if (this->cboDirectDamage->SelectedIndex == 1) {
			m_chartType = CommConst::STEP13_CHART_11;
		}
		Debug::WriteLine("========= after ========>m_chartType:" + m_chartType);
	...
	private: System::Void cboIndirectDamage_SelectionChangeCommitted(System::Object^ sender, System::EventArgs^ e) {
		...
		Debug::WriteLine("========= before ========>m_chartType:" + m_chartType);
		if (this->cboIndirectDamage->SelectedIndex == 0) {
			m_chartType = CommConst::STEP13_CHART_00;
		}
		else if (this->cboIndirectDamage->SelectedIndex == 1) {
			m_chartType = CommConst::STEP13_CHART_01;
		}
		Debug::WriteLine("========= after ========>m_chartType:" + m_chartType);
	...
	private: System::Void dgvPriority_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
		...
		Debug::WriteLine(String::Format("========>dgvPriority_CellClick.columnIndex[{0}]", columnIndex));
		Debug::WriteLine(String::Format("========>dgvPriority_CellClick.rowIndex[{0}]", rowIndex));


		if (this->m_chartType->Equals(CommConst::STEP13_CHART_21) 
			|| this->m_chartType->Equals(CommConst::STEP13_CHART_22)
			|| this->m_chartType->Equals(CommConst::STEP13_CHART_23)
			) {
			

			int iColCnt  = this->dgvPriority->ColumnCount;

			String^ strVal_0 = this->dgvPriority->Rows[rowIndex]->Cells[0]->Value->ToString();
			String^ strVal_1 = this->dgvPriority->Rows[rowIndex]->Cells[1]->Value->ToString();
			String^ strVal_2 = this->dgvPriority->Rows[rowIndex]->Cells[2]->Value->ToString();
			String^ strVal_3 = this->dgvPriority->Rows[rowIndex]->Cells[3]->Value->ToString();

			//각각의 시설물에 해당하는 경로 같은 거 찾아야 함
			...
			chart->setPlotArea(80, 80, plotAreaWidth, plotAreaHeight, 0xffffff, -1, 0xeeeeee, 0xeeeeee, -1);
			...
			for (int i = 0; i < shape->m_nRecords; i++)
			{
				...
				//Debug::WriteLine(String::Format("========>strVal_0[{0}]", strVal_0));
				//Debug::WriteLine(String::Format("========>linkID[{0}]", linkID));
				int colorInt = ColorToInt(Color::Black);
				
				if (linkID->Equals(strVal_0)) {
					colorInt = ColorToInt(Color::Red);
					Debug::WriteLine(String::Format("========>strVal_0[{0}]", strVal_0));
					Debug::WriteLine(String::Format("========>linkID[{0}]", linkID));
				}else if (linkID->Equals(strVal_1)) {
					colorInt = ColorToInt(Color::Blue);
					Debug::WriteLine(String::Format("========>strVal_1[{0}]", strVal_1));
					Debug::WriteLine(String::Format("========>linkID[{0}]", linkID));
				}else if (linkID->Equals(strVal_2)) {
					colorInt = ColorToInt(Color::Yellow);
					Debug::WriteLine(String::Format("========>strVal_2[{0}]", strVal_2));
					Debug::WriteLine(String::Format("========>linkID[{0}]", linkID));
				}else if (linkID->Equals(strVal_3)) {
					colorInt = ColorToInt(Color::LightGreen);
					Debug::WriteLine(String::Format("========>strVal_3[{0}]", strVal_3));
					Debug::WriteLine(String::Format("========>linkID[{0}]", linkID));
				}
				...
				//int colorInt = (shape->m_SHPProperties[i]->IsClose) ? ColorToInt(Color::Red) : ColorToInt(Color::LightGreen);
