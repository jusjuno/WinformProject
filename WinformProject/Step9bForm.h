...
#pragma endregion
		...
		private:
			...
			bool CreateInputFiles() {
				...
				//1. input_Bridge_fragility_curve.xlsx
				String^ filename = "input_Bridge_fragility_curve.xlsx";				
				...
				//2. input_Location_br.xlsx
				filename = "input_Location_br.xlsx";
				...
				//3. input_Location_eq.xlsx
				filename = "input_Location_eq.xlsx";
				if (!m_UNISTHelper->WriteLocationEq(filename)) {
					Alert::Error(String::Format(errMsg, filename));
					return false;
				}
				AppendLogDele(String::Format(okMsg, filename));
				...
				//4. input_M_eq.xlsx
				filename = "input_M_eq.xlsx";
				if (!m_UNISTHelper->WriteMEq(filename)) {
					Alert::Error(String::Format(errMsg, filename));
					return false;
				}
				AppendLogDele(String::Format(okMsg, filename));
				...
				//6. input_No_samples.xlsx
				filename = "input_No_samples.xlsx";
				...
				//7. input_Restoration_days.xlsx
				filename = "input_Restoration_days.xlsx";
