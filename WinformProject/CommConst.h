...
*/
	...
	literal float DEFAULT_TRAFFIC_CARRYING_DAMAGE_STATE1 = 0.6;
	literal float DEFAULT_TRAFFIC_CARRYING_DAMAGE_STATE2 = 2.5;
	literal float DEFAULT_TRAFFIC_CARRYING_DAMAGE_STATE3 = 75;
	literal float DEFAULT_TRAFFIC_CARRYING_DAMAGE_STATE4 = 230;
	literal float DEFAULT_TRAFFIC_CARRYING_DAMAGE_REF = 250;
